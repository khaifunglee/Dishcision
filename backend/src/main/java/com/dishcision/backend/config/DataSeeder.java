...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        seed("Chicken Breast", "g", UnitType.WEIGHT, "Protein",
                List.of("chicken", "chicken breasts", "breast of chicken", "chicken fillet", "chicken fillets"));
        ...
        seed("Pasta (Penne)", "g", UnitType.WEIGHT, "Pantry Staple",
                List.of("penne", "pasta", "rigatoni", "fusilli", "spaghetti", "fettuccine", "linguine"));
        ...
        seed("Canned Tomatoes", "g", UnitType.WEIGHT, "Pantry Staple",
                List.of("crushed tomatoes", "diced tomatoes", "tinned tomatoes", "tomato puree", "passata"));
    ...
    // Seeding method to create ingredient and ingredient alias names
